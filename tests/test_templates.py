...
class ConsumerTemplateTests(unittest.TestCase):
    ...
    def test_executor_has_merge_and_repair_actions(self):
        ...
        self.assertIn("post-merge-workflows.txt", text)
        self.assertIn("Release is intentionally NOT dispatched here", text)
    ...
    def test_reconciler_waits_for_post_merge_gates_and_emits_done_itself(self):
        ...
        self.assertIn("Dispatching Release only after all post-merge gates succeeded.", text)
        self.assertIn("Release workflow succeeded without GitHub Release proof", text)
